...
object LibXposedApiByteCodeGenerator {
    ...
    fun impl1(
        ...
        val namespace = PackageNames.THIS.replace(".", "/")
        val typeInvocationParamWrapper =
            $$"L$${namespace}/loader/modern/Lsp100HookWrapper$InvocationParamWrapper;"
        val typeLsp100HookAgent =
            $$"L$${namespace}/loader/modern/Lsp100HookWrapper$Lsp100HookAgent;"
